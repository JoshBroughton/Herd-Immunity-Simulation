class Logger(object):
    '''
    Logger class, contains methods to write simulation data to a log file.
    '''
    ...
    def write_metadata(self, pop_size, vacc_percentage, virus_name, mortality_rate,
                       basic_repro_num):
        '''
        Writes simulation metadata to the log file.
        '''
    ...
    def log_interactions(self, step_number, number_of_interactions, number_of_new_infections):
        '''
        Writes summary data of interactions for each time step.
        '''
    ...
    def log_infection_survival(self, step_number, population_count, number_of_new_fatalities):
        '''
        Writes survival data for each time step to the log file.
        '''
    ...
    def log_final(self, survivors, deaths, vaccine_saves, interactions, infections):
        '''
        Writes final summary data to the log file at the end of the simulation.
        '''
